...
$curs1 = OCI_parse($connection, "SELECT part.part_number, part_name FROM part,component
					             WHERE part.part_number = component.part_number_component
					               AND component.part_number = $partid");
if(OCIError($curs1))
	{
...
while (OCIfetch($curs1))
	...
	$chain .= "$part_id  &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp $part_name<br>\n";
