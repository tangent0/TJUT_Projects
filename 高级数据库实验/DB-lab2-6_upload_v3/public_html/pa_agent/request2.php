...
$curs2 = OCI_parse($connection, "insert into part values($num,'$name',$stock,$min,$ordered,'$unit',$price)");
OCIExecute($curs2, OCI_COMMIT_ON_SUCCESS);
$chain .="<p></p>";
$chain .= "<p><b>record inserted</b></p>";
$chain .= "<p><b>result:</b><p>";

$curs1 = OCI_parse($connection, "SELECT part_number, part_name FROM part");
if(OCIError($curs1))
	{
...
OCI_Define_By_Name($curs1,"PART_NAME",$name);
