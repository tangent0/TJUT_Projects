...
$curs1 = OCI_parse($connection, "SELECT * FROM pa_agent where emp_num like '$emp_num1%'");
if(OCIError($curs1))
	{
...
*/
OCI_Define_By_Name($curs1,"EMP_NUM",$emp_num);
...
while (OCIfetch($curs1))
	...
	$chain .= "$emp_num  &nbsp &nbsp &nbsp &nbsp &nbsp $pa_name<br>\n";
